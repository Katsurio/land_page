 ...
 */
// this turns magic_quotes on via .htaccess file
...
// user nobody (or www) will be creating the file, so we need to make the dir world-writable briefly..
...
system("echo php_flag magic_quotes_gpc on >> $filename");

// turn the dir back to the proper perms..
